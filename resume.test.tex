...
\begin{tabularx}{\linewidth}{@{}l X@{}}
  \textsc{Address} & \small{Institute of Astrophysics and Space Sciences} \\
                   & \small{Rua das Estrelas 4150-762 Porto, PORTUGAL} \\
  \textsc{Phone}   & \small{+351 226 089 882}\\
  \textsc{email}   & \href{mailto:joao.faria@astro.up.pt}{joao.faria@astro.up.pt} \\
\end{tabularx}
...
\section{Online}
\begin{tabularx}{\linewidth}{@{}l X@{}}
  \textsc{Website}  & \href{http://www.astro.up.pt/~jfaria}{http://www.astro.up.pt/~jfaria} \\
  \textsc{Twitter}     & \href{https://twitter.com/astroaware}{@astroaware} \\
  \textsc{github}      & \href{http://www.github.com/j-faria}{github.com/j-faria}\\
