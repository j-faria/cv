...
\begin{center}
  Full list in \href{https://ui.adsabs.harvard.edu/\#/public-libraries/OtQQjddpThGyGAflYLVxng}{ADS} \qquad
      \textbf{40} refereed papers. \textbf{496} citations\\
  \hskip-.5em or at \href{https://joaofaria.space/publications}{joaofaria.space/publications} \qquad % \hspace{4cm} 
      \textbf{5} first-author papers. \textbf{50} citations, \textbf{3} self-citations
...
\begin{refsection}
  % \nocite{*}
  \nocite{Faria2019,Faria2018,Faria2016,Faria2016a}
...
\ifoutreach
  ...
  \section{Outreach}
    ...
    \item \emph{Press coverage} on the first ESPRESSO results (\href{https://arxiv.org/abs/1911.11714}{Faria+$\,$2020}):
