...
\paperlistattachedtrue % comment out to hide full list of papers
...
\begin{multicols}{2}\begin{itemize}[leftmargin=0em]
  \item[-] M.Sc.-level fellowship: João D. Camacho (IA) \\[-1.2em]
...
% \begin{itemize}[leftmargin=*]
  \item[] \href{http://github.com/j-faria/kima}{kima}: %
          Exoplanet detection in RVs with DNest4 and GPs \\[-1.6em]
  \item[] \href{http://github.com/j-faria/bgls}{BGLS}: %
           Bayesian version of the Generalized Lomb-Scargle periodogram, described in Mortier et al. (2015)  \\[-1.6em]
