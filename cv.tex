...
\newif\iflanguages
\languagestrue % comment out to hide technical skills and languages
...
\begin{center}
 ...
 \textbf{39} refereed papers. \textbf{489} citations\\
 \hspace{5.3cm} \textbf{5} first-author papers. \textbf{50} citations, \textbf{3} self-citations
...
\begin{refsection}
  % \nocite{*}
  \nocite{Faria2019,kima,Faria2016a,Faria2016b}
...
\begin{refsection}
  ...
  \ifallpapers % list ALL the papers!
    \nocite{Nelson2020, Pereira2019, Sousa2019, Oshagh2018, Martins2018, Serrano2018, 
            UlmerMoll2019, LilloBox2018, Santerne2018,
...
\begin{multicols}{2}\begin{itemize}[leftmargin=1em]
  \item[-] Ph.D. project: João D. Camacho (IA, U. Porto) \\
           \emph{``Statistical Data Analysis Methods for the detection of Other Earths''}\\[-1.2em]
  \item[-] M.Sc.-level fellowship: João Gomes da Silva (IA) \\
           \emph{new activity indicators; development of \href{https://github.com/gomesdasilva/ACTIN}{ACTIN}}\\[-1.2em]
  \item[-] M.Sc. thesis project: João D. Camacho (IA, U. Porto) \\
           \emph{``Gaussian processes [... for ...] exoplanet search''}\\[-1.2em]
  \item[-] Undergraduate project: Ishan Mishra (I\,IT, India)\\
           \emph{``Spectral Activity Indices calculation tool''}
  \vfill\null
  \columnbreak
  % \item[]\\
  % \item[]
...
% \begin{itemize}[leftmargin=*]
  \item[-] \href{http://github.com/j-faria/ESPRESSO-public}{ESPRESSO}: %
          Tools to download and analyse ESPRESSO data (public release in 2020)\\[-1.6em]
