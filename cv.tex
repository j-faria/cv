...
\newcommand{\myprenote}{%
\begin{center}
  Full list in \href{https://ui.adsabs.harvard.edu/\#/public-libraries/OtQQjddpThGyGAflYLVxng}{ADS} \qquad
 \textbf{27} refereed papers. \textbf{274} citations\\
 \hspace{5.2cm} \textbf{4} first-author papers. \textbf{28} citations, \textbf{1} self-citation
...
\begin{refsection}
  % \nocite{*}
  \nocite{kima,Faria2016a,Faria2016b}
...
\begin{refsection}
  ...
  \ifallpapers % list ALL the papers!
    \nocite{Oshagh2018, Martins2018, Serrano2018, DelgadoMena2018, LilloBox2018, Nelson2018, Santerne2018,
            Barros2018, Santos2018, Santos2017a, Lillo-Box2017, Oshagh2017, Barros2017, Santos2017,
            Adibekyan2016a, Santos2016, Figueira2016a, Adibekyan2016, Figueira2016, Mortier2015b,
            Adibekyan2015, Martins2015, Mortier2015a, Figueira2014, Verma2014, Santos2014, Faria2012}
    
    \printbibliography[title=Other publications, heading=subbibliography]
...
\begin{itemize}\itemsep-0.3em
  \item PI of \textbf{1} accepted ESO observing proposal (ESPRESSO\,\raisebox{0.8\depth}{@}\,VLT)
  \item co-I of \textbf{10} accepted ESO/OPTICON observing proposals
  ...
  \item (awaiting approval) ESPRESSO Science Team \textit{collaborator}
...
\begin{multicols}{2}\begin{itemize}[leftmargin=0em]
  \item[-] Ph.D. project: João D. Camacho (IA) \\[-1.2em]
          %  {\small Advanced Statistical Data Analysis Methods for the detection of Other Earths}\\[-1.2em]
  \item[-] M.Sc.-level fellowship: João Gomes da Silva (IA) \\[-1.2em]
  \item[-] M.Sc. thesis project: João D. Camacho (IA) \\[-1.2em]
